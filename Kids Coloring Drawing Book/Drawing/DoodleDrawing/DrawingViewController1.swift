...
@available(iOS 18.0, *)
class DrawingViewController1: UIViewController, PKCanvasViewDelegate, PKToolPickerObserver, UIPencilInteractionDelegate {
    ...
    func updateContentSizeForDrawing() {
        ...
        if !drawing.bounds.isNull {
            contentHeight = max(canvasView.bounds.height, (drawing.bounds.maxY + DrawingViewController1.canvasOverscrollHeight) * canvasView.zoomScale)
        } else {
